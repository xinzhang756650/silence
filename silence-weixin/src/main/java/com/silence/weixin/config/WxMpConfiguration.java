...
import com.silence.weixin.handler.*;
    ...
    public WxMpService wxMpService() {
        ...
        service.setMultiConfigStorages(configs
                .stream().map(a -> {
                    ...
                    configStorage.setAppId(EncryptUtil.AESdecode(a.getAppId(),WxMpProperties.AESkey));
                    configStorage.setSecret(EncryptUtil.AESdecode(a.getSecret(),WxMpProperties.AESkey));
                    configStorage.setToken(EncryptUtil.AESdecode(a.getToken(),WxMpProperties.AESkey));
                    configStorage.setAesKey(EncryptUtil.AESdecode(a.getAesKey(),WxMpProperties.AESkey));
